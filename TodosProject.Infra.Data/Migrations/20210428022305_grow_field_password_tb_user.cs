...
{
    public partial class grow_field_password_tb_user : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                columns: new[] { "Created_Time", "Is_Active" },
                values: new object[] { new DateTime(2021, 4, 27, 22, 13, 1, 14, DateTimeKind.Local).AddTicks(268), true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2L,
                columns: new[] { "Created_Time", "Is_Active" },
                values: new object[] { new DateTime(2021, 4, 27, 22, 13, 1, 14, DateTimeKind.Local).AddTicks(8859), true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3L,
                columns: new[] { "Created_Time", "Is_Active" },
                values: new object[] { new DateTime(2021, 4, 27, 22, 13, 1, 14, DateTimeKind.Local).AddTicks(8897), true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                column: "Created_Time",
                value: new DateTime(2021, 4, 27, 22, 13, 1, 15, DateTimeKind.Local).AddTicks(8979));
        }
    }
}
