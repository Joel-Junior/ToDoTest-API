...
namespace TodosProject.Infra.Data.Mapping
{
    public class UserMapping : IEntityTypeConfiguration<User>
    {
        ...
        private void ConfigureColumns()
        {
            ...
            _builder.Property(p => p.Name).IsRequired(false).HasColumnName("Name").HasColumnType("VARCHAR(300)");
            _builder.Property(p => p.Phone).IsRequired(false).HasColumnName("Phone").HasColumnType("VARCHAR(100)");
        }
    }
}
